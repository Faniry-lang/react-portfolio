        ...
        <section id="projects" className="relative flex flex-col h-[calc(100vh-2.5rem)] w-screen items-center justify-center overflow-hidden bg-slate-50 pt-10 scroll-mt-12">
            <div className="relative h-full w-full">
                ...
                <button
                    ...
                    className="absolute left-4 top-1/2 z-20 flex h-12 w-12 -translate-y-1/2 items-center justify-center cursor-pointer bg-white/50 text-slate-900 transition hover:bg-slate-50 pointer-fine:active:bg-slate-50 hover:text-white"
                >
                ...
                <button
                    ...
                    className="absolute right-4 top-1/2 z-20 flex h-12 w-12 -translate-y-1/2 items-center justify-center cursor-pointer bg-white/50 text-slate-900 transition hover:bg-slate-50 pointer-fine:active:bg-slate-50 hover:text-white"
                >
